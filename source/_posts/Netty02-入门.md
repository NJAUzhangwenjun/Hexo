...
**Future**最早出现于JDK的java.util.concurrent.Future,它用于表示异步操作的结果.由于Netty的**Future**都是与异步I/O操作相关的,因此命名为**ChannelFuture**,代表它与Channel操作相关.

由于Netty中的所有I / O操作都是异步的,因此Netty为了解决调用者如何获取异步操作结果的问题而专门设计了**ChannelFuture**接口.
