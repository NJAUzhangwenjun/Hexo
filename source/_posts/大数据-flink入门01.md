...
![img](../images/大数据-flink入门.assets/2-16.004.jpeg)
...
![img](../images/大数据-flink入门.assets/3-.005.jpeg)
...
![img](../images/大数据-flink入门.assets/4-.006.jpeg)
...
![img](../images/大数据-flink入门.assets/5.-幻灯片04.png)
...
![img](../images/大数据-flink入门.assets/6.-幻灯片07.png)
...
![img](../images/大数据-flink入门.assets/7.-幻灯片08.png)

流式处理简单来讲即有一个无穷无尽的数据源在持续收取数据，以代码作为数据处理的基础逻辑，数据源的数据经过代码处理后产生出结果，然后输出，这就是流式处理的基本原理。

#### 4.分布式流式处理

![img](../images/大数据-flink入门.assets/8.-幻灯片09.png)
...
![img](../images/大数据-flink入门.assets/9.-幻灯片10.png)
...
![img](../images/大数据-flink入门.assets/10.-幻灯片11.png)
...
![img](../images/大数据-flink入门.assets/11.-幻灯片21.png)
...
![img](../images/大数据-flink入门.assets/12.-幻灯片22.png)
...
![img](../images/大数据-flink入门.assets/13.-幻灯片23.png)
...
![img](../images/大数据-flink入门.assets/14.-幻灯片25.png)
...
![img](../images/大数据-flink入门.assets/15.-幻灯片26.png)
...
![img](../images/大数据-flink入门.assets/16.-幻灯片27.png)
...
![img](../images/大数据-flink入门.assets/17.-幻灯片34.png)
...
![img](../images/大数据-flink入门.assets/18.-幻灯片37.png)
...
![img](../images/大数据-flink入门.assets/19.-幻灯片40.png)
...
![img](../images/大数据-flink入门.assets/22.-幻灯片45.png)
...
![img](../images/大数据-flink入门.assets/23.-幻灯片46.png)
...
![img](../images/大数据-flink入门.assets/24.-幻灯片49.png)
